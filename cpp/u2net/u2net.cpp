...
int main(int argc, const char* argv[]) 
{
    ...
    std::string imgpath("/home/zk/src/images/7.jpg");
    std::cout<<"you want to inference: "<< imgpath<<std::endl;
    

    // create net from model file
    std::shared_ptr<Interpreter> net(Interpreter::createFromFile("/home/zk/src/ZKnn/model/u2netp-1.mnn"));
    if(net == nullptr)
        std::cout<<"Create net from file failed"<<std::endl;
    else
    {
    ...
    std::cout<<"getSessionInput"<<std::endl;
